...
tour.addStep({
    id: 'comparer',
    text:
        `<p>Explore this map to detect changes. If you notice a difference between the images:
            <ul>
...
tour.addStep({
    id: 'image-controls',
    text: 'The image controls allow you to adjust the display of the images individually. In blink / fade mode, a white' +
